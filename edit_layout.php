        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6 hidden">
            <h1 class="m-0">User Information (ID) : <?= htmlspecialchars($id) ?>
                <span class="ml-2">
                <button type="button" class="btn btn-warning btn-md" data-bs-toggle="modal" data-bs-target="#userFormModal">Edit 
            ...
            <section>
                    ...
                    <div class="modal-dialog modal-lg"> <!-- large modal -->
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="userFormModalLabel">Update User</h5>
                        ...
                        <form action="./update_db.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="f_name" id="f_name" placeholder="Enter firstname" required value="<?= htmlspecialchars($user['f_name']) ?>">
                                </div>

                                <div class="mb-2">
                                    <label for="l_name" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" name="l_name" id="l_name" placeholder="Enter lastname" required value="<?= htmlspecialchars($user['l_name']) ?>">
                                </div>

                                <div class="mb-2">
                                    <label for="age" class="form-label">Age</label>
                                    <input type="number" class="form-control" name="age" id="age" placeholder="Enter age" required value="<?= htmlspecialchars($user['age']) ?>">
                                </div>

                                <div class="mb-2">
                                    <label for="phone" class="form-label">Phone</label>
                                    <input type="text" class="form-control" name="phone" id="phone" placeholder="Enter Telephone number" required value="<?= htmlspecialchars($user['phone']) ?>">
                                </div>

                                <div class="mb-2">
                                    <label for="address" class="form-label">Address</label>
                                    <textarea class="form-control" name="address" id="address" rows="3" placeholder="Enter Address" required><?= htmlspecialchars($user['address']) ?></textarea>
                                </div>

                                <div class="mb-2">
                                    <label for="country" class="form-label">Country</label>
                                    <input type="text" class="form-control" name="country" id="country" placeholder="Enter country" required value="<?= htmlspecialchars($user['country']) ?>">
                                </div>
